  ...
  return (
    ...
    >
      ...
      <div className="p-3 flex items-center justify-between">
        {!isCollapsed && (
          <h1 className="text-lg font-medium text-gray-200">Multi-Modal RAG</h1>
        )}
        <button
      ...
      <div className="px-3 pb-3">
        <button
          ...
          className={`w-full bg-[#252525] hover:bg-[#2a2a2a] border border-transparent hover:border-white rounded-lg transition-colors flex items-center gap-3 ${
